...
set testBin=%srcDir%\Tests\Saturn72.UnitTesting.Framework.Tests\bin\%config%\Saturn72.UnitTesting.Framework.Tests.dll
...
echo using nunit runner from location %nunitExe%
...
REM echo push %prjBinDir%* directory content to nuget
REM %NuGet% push %prjDir%*
